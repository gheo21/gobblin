 ...
 */
public class AvroToParquetTimePartitionedWriterBuilder extends AvroToParquetDataWriterBuilder {
  ...
  public DataWriter<GenericRecord> build() throws IOException {
    ...
    switch (this.destination.getType()) {
      case HDFS:
        return new AvroToParquetHdfsTimePartitionedWriter(this.destination, this.writerId, this.schema, this.format,
